...
<template>
  <div class="min-h-screen bg-white font-sans text-slate-800 antialiased">
    ...
    <header class="fixed inset-x-0 top-0 z-50 border-b border-slate-200/80 bg-white/85 backdrop-blur-md">
      <div class="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6 lg:h-20 lg:px-8">
        <a href="/" class="flex items-center" aria-label="LampungMediaWeb — Jasa Website Lampung">
          <AppLogo class="text-[16px] sm:text-[23px] lg:text-[26px]" />
        </a>
    ...
    <!-- Mobile menu -->
    <div v-if="open" class="fixed inset-x-0 top-16 z-40 border-b border-slate-200 bg-white px-4 py-4 shadow-lg md:hidden">
    ...
    <!-- Footer -->
    <footer class="bg-brand-900 pb-8 text-brand-200">
      <div class="mx-auto max-w-6xl px-4 pt-16 sm:px-6 lg:px-8">
        <div class="grid gap-10 md:grid-cols-2 lg:grid-cols-4 lg:gap-12">
          ...
          <div>
            <h4 class="text-lg font-bold text-white">Layanan</h4>
          ...
          <div>
            <h4 class="text-lg font-bold text-white">Perusahaan</h4>
            <ul class="mt-5 space-y-3 text-sm font-medium">
        ...
        <div class="mt-14 flex flex-col items-center justify-between gap-3 border-t border-brand-800 pt-8 text-sm font-medium text-brand-300 sm:flex-row">
